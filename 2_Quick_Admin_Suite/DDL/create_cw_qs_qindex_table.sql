CREATE EXTERNAL TABLE `cw_qs_qindex`(
  ...
  `dimensions` struct<quickinstanceid:string> COMMENT 'QuickSight Q instance identifier', 
...
TBLPROPERTIES (
  ...
  'storage.location.template'='s3://cw-qs-qindex-905178920046/${year}/${month}/${day}/${hour}/',
  'classification'='json',
