CREATE EXTERNAL TABLE `cw_qs_ds`(
  ...
  `dimensions` struct<datasetid:string> COMMENT 'QuickSight dataset identifier', 
...
LOCATION
  's3://metricstreams-cw-qs-ds-rd25gemp/'
TBLPROPERTIES (
  ...
  'storage.location.template'='s3://metricstreams-cw-qs-ds-rd25gemp/${year}/${month}/${day}/${hour}/',
  'classification'='json',
