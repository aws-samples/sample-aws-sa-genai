CREATE EXTERNAL TABLE `cw_qs_spice`(
  ...
  `dimensions` struct<> COMMENT 'SPICE metrics have no dimensions', 
...
TBLPROPERTIES (
  ...
  'storage.location.template'='s3://cw-qs-spice-905178920046/${year}/${month}/${day}/${hour}/',
  'classification'='json',
