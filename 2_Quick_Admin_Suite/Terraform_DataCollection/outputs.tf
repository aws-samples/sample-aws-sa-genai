output "group_membership" {
  ...
  value       = "s3://admin-suite-${data.aws_caller_identity.current.account_id}/monitoring/quicksight/group_membership"
}
...
output "object_access" {
  ...
  value       = "s3://admin-suite-${data.aws_caller_identity.current.account_id}/monitoring/quicksight/object_access"
}
...
output "folder_assets" {
  ...
  value       = "s3://admin-suite-${data.aws_caller_identity.current.account_id}/monitoring/quicksight/folder_assets/folder_assets.csv"
}

output "folder_lk" {
  description = "The s3 location of folder_lk.csv for you to utilize in next Athena tables creation stack"
  value       = "s3://admin-suite-${data.aws_caller_identity.current.account_id}/monitoring/quicksight/folder_lk/folder_lk.csv"
}

output "folder_path" {
  description = "The s3 location of folder_path.csv for you to utilize in next Athena tables creation stack"
  value       = "s3://admin-suite-${data.aws_caller_identity.current.account_id}/monitoring/quicksight/folder_path/folder_path.csv"
}
...
output "datasets_properties" {
  ...
  value       = "s3://admin-suite-${data.aws_caller_identity.current.account_id}/monitoring/quicksight/datasets_properties/datasets_properties.csv"
}
...
output "datasource_property" {
  ...
  value       = "s3://admin-suite-${data.aws_caller_identity.current.account_id}/monitoring/quicksight/datasource_property/datasource_property.csv"
}