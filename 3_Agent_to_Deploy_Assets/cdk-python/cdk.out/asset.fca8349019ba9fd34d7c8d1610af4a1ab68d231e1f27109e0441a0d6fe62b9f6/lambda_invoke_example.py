...
def example_payloads():
    ...
    return {
        ...
        'biops-import-assets': {
            's3_uri': 's3://biops-version-control-demo-038198578763/QUICKSIGHT_JSON_d41a3c00-e581-4ec2-969c-4778562bedd3_499080683179_2025-11-21/QUICKSIGHT_JSON_d41a3c00-e581-4ec2-969c-4778562bedd3_499080683179_2025-11-21.qs', # 's3://bucket/path/bundle.zip' Example S3 URI
            'source_asset_id': 'd41a3c00-e581-4ec2-969c-4778562bedd3',# 'dashboard-id-123'
            'target_account_id': '058421552426', #'210987654321'
            'target_role_name': 'BiopsTargetAccountRole', #'QuickSightRole'
            'aws_region': 'us-east-1'
